...
class MainValidatorsTest(unittest.TestCase):
    ...
    def test_type_validator(self):
        ...
        with self.subTest(src_text='base pass'):
            v = djburger.validators.c.Type(int)
            v = v(3)
        ...
        with self.subTest(src_text='bool pass'):
            v = djburger.validators.c.IsBool
            v = v(False)
            self.assertTrue(v.is_valid())
        ...
        with self.subTest(src_text='float pass'):
            v = djburger.validators.c.IsFloat
            v = v(3.2)
            self.assertTrue(v.is_valid())
        ...
        with self.subTest(src_text='dict pass'):
            v = djburger.validators.c.IsDict
            v = v({1: 2})
            self.assertTrue(v.is_valid())
        ...
        with self.subTest(src_text='list pass'):
            v = djburger.validators.c.IsList
            v = v([1, 2])
            self.assertTrue(v.is_valid())
    ...
    def test_list_validator(self):
        with self.subTest(src_text='list int pass'):
            v = djburger.validators.c.List(djburger.validators.c.IsInt)
            v = v([1, 2, 3])
            self.assertTrue(v.is_valid())
        ...
        with self.subTest(src_text='list str pass'):
            v = djburger.validators.c.List(djburger.validators.c.IsStr)
            v = v(['1', '2', '3'])
            self.assertTrue(v.is_valid())
        ...
        with self.subTest(src_text='list list str pass'):
            v = djburger.validators.c.List(
                djburger.validators.c.List(
                    djburger.validators.c.IsStr
                )
            )
    ...
    def test_dict_mixed_validator(self):
        with self.subTest(src_text='dict int+str pass'):
            v = djburger.validators.c.DictMixed(validators={
                'ping': djburger.validators.c.IsInt,
                'pong': djburger.validators.c.IsStr,
            })
            v = v(data={
                'ping': 3,
                'pong': 'test',
    ...
    def test_lambda_validator(self):
        with self.subTest(src_text='lambda int pass'):
            v = djburger.validators.c.Lambda(key=lambda data: data > 0)
            v = v(4)
            self.assertTrue(v.is_valid())
    ...
    def test_clean_validator(self):
        with self.subTest(src_text='lambda int pass'):
            v = djburger.validators.c.Clean(key=lambda data: int(data))
            v = v('4')
            v.is_valid()
    ...
    def test_chain_validator(self):
        with self.subTest(src_text='chain int pass'):
            v = djburger.validators.c.Chain([
                djburger.validators.c.IsInt,
                djburger.validators.c.Lambda(key=lambda data: data > 0),
            ])
            v = v(4)
            self.assertTrue(v.is_valid())
        with self.subTest(src_text='lambda int not pass'):
